...
$wp_query=new WP_Query('post_type=product&product_cat=steady-seller&orderby=menu_order&order=asc&showposts=12&paged='.$paged);
...
echo $content;
?><?php */?>
 <?php /*?><?php $buy = get_option('revchurch_buy'); ?><?php */?>
...
?> 
    ...
    <div class="product_panel">
    <?php $i=1;
        $args = array( 'post_type' => 'product', 'posts_per_page' => 3, 'product_cat' => 'book-of-the-month', 'orderby' => 'menu_order', 'order' => 'asc' );
