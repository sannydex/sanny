...
$wp_query=new WP_Query('post_type=product&product_cat=book-of-the-month&orderby=menu_order&order=asc&showposts=12&paged='.$paged);
//echo $wp_query->request;
if ($wp_query->found_posts) : while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
        
          <?php $published=get_post_meta($post->ID, "wpcf-published", true); ?>   
...
<?php }?>
            	...
            	<div class="info">
                <?php if($published!=""){?><h2><?php echo stripslashes($published); ?></h2><?php }?>
...
?> 
    ...
    <div class="product_panel">
    <?php $i=1;
        $args = array( 'post_type' => 'product', 'posts_per_page' => 3, 'product_cat' => 'steady-seller', 'orderby' => 'menu_order', 'order' => 'asc' );
