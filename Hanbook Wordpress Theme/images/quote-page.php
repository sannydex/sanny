...
Greetings,<br/>
A Customer registered as $user_name ($user_mail) have sent a new quote request, find details below:<br/>
<strong> Name:</strong> $book_name <br/> 
<strong>Quantity:</strong> $quantity <br/> 
<strong>Description:</strong> $book_description<br/><br/>
If you want to approve this Quote, you'll need to create a new product regarding this quote. Please navigate to the link below to create new product.
...
If you want to approve or cancel this request, please visit the below link. (Steps are clearly defined in the Manual DOC.)<br/>
