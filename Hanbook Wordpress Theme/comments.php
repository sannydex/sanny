...
<h2 id="postcomment"><?php comments_number(__('No Comments'), __('1 Comment'), __('% Comments')); ?>
...
<div class="cmntb"><p><input name="image" value="Submit"  alt="Submit" type="submit" class="button"  border="0" >
